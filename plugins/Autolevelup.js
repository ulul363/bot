...
*Role:* ${user.role}`;
            ...
            conn.sendMessage(m.chat, { image: { url: global.thumb }, caption: text.trim() })
        }
    }
}
...
function sort(property, ascending = true) {
    if (property) {
        return (...args) => args[ascending ? 0 : 1][property] - args[ascending ? 1 : 0][property]
    } else {
        return (...args) => args[ascending ? 0 : 1] - args[ascending ? 1 : 0]
    }
}
