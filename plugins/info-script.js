...
│• Script : 
│↳ Beli ke 6283843362676
│• Node_Modules:
│↳ Download di panel atau di replit
│• Base : 
...
let url = gamanaufal[Math.floor(Math.random() * gamanaufal.length)]
 ...
 await conn.reply(m.chat, list, m, { render: true, thum: url, source: sgh, iklan: true, body: 'S C R I P T A K A Z A M D' })
